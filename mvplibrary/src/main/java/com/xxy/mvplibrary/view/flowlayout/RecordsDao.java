package com.xxy.mvplibrary.view.flowlayout;
...
public class RecordsDao {
    ...
    private com.xxy.mvplibrary.view.flowlayout.RecordSQLiteOpenHelper recordHelper;
    private NotifyDataChanged mNotifyDataChanged;
    private String mUsername;

    public RecordsDao(Context context, String username) {
        recordHelper = new com.xxy.mvplibrary.view.flowlayout.RecordSQLiteOpenHelper(context);
        mUsername = username;
    }
